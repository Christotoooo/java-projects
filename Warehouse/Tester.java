...
public class Tester {
 ...
 // System.out.println(warehouse.print());
  ...
  warehouse.storage[2].removeBox("Box 2");
    //warehouse.storage[1].removeBox("Box 3");
    //System.out.println(warehouse.print());
 ...
 // System.out.println(warehouse.print());
  //System.out.println(testShip);
    ...
    //  System.out.println(testShip2);
      //      System.out.println(testShip4);
        //          System.out.println(testShip3);
          //              System.out.println(testShip5);
                        
            //            System.out.println(warehouse.print().equals(testShip));
              //          System.out.println(warehouse.printShipping().equals(testShipping));
  ...
  //TESTING MOVE ONE BOX
     // System.out.println(warehouse.print());//test
...
//  System.out.println(warehouse.print());//test
 ...
 // System.out.println(testReorganize);//test
